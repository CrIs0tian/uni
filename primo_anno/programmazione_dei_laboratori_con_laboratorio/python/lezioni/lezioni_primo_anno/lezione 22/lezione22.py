...
plt.plot(x,y0, c='r', label='bubble-sort') #plot = disegna grafico / (x=lista,y=lista perfforza)/ c=colore/ label ( nome linea grafico)
plt.plot(x,y1, c='b', label='merge-sort')
plt.legend() #setta la legenda nel grafico, cosi chiamata la prende nei comandi label del plot
