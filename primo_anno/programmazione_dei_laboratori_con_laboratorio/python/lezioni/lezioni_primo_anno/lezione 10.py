...
a = [10, 10, 10, 5, 5, 0]
b = a  # aliasing, aggiunge un puntatore alla lista nominata con a, quindi a e b puntano alla stessa lista
c = a[:]  # clonazione, autoesplicativo
b[1] = "casa"
c[0] = None
print(a)
print(b)
