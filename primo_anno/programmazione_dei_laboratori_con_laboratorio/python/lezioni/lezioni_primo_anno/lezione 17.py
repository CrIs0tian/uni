...
#
# O(m*log n) caso peggiore


def hist2(a, bins=[i * 10 for i in range(10)]):
    """
    Input: a una lista di m float e bins una lista di n-1 floats ordinati in modo crescente
    Output: una lista h di n floats tale che:
        - h[0] = numero di elementi in v < bins[0]
...
print(hist2([1, 3, -8, 10, 12, 9]))


# In[] comprensione delle liste
a = [i**2 for i in range(10)]  # formato ----> [f(i) for i in end]
print(a)


# In[]
t = (1, 2, 3, 4)
a = list(t)  # costo lineare, come in tuple(list)
print(a)
...
if (
    "k9" in d1
):  # controlla le chiavi! se vogliamo che controlla i valori imponiamo d1.values()
    print(d1["k9"])
else:
    d1["k9"] = "cappanove"

print(d1)  # stampa tutto il dizionario {k1:v1, k2:v2,....}
...
print(len(d1))  # calcola il numero di chiavi contenute nel dizionario
