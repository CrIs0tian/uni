#include <stdio.h>
#include <stdlib.h>
#include <string.h> /*per operazioni come strlen, strcpy strcmp etc.*/
...
void set_sequenza(sequenza v, int p, tiposeq x) { v.a[p] = x; }

tiposeq get_sequenza(sequenza v, int p) { return v.a[p]; }
