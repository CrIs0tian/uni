...
sequenza nuova_sequenza() {
  ...
  sequenza v = {NULL, 0, 0};
  /* quindi *a=NULL (nietne indirizzo), n = 0, c = 0*/
...
void set_sequenza(sequenza v, int p, float x) { v.a[p] = x; }

float get_sequenza(sequenza v, int p) { return v.a[p]; }

int dim_sequenza(sequenza s) { return s.n; }

int cap_sequenza(sequenza s) { return s.c; }
/* per capire che a C non frega un cazzo della formattazione,
basta che chiudi il tutto in due {} e rispetti la regola del punto e
virgola, poi dentro le righe puoi formattarle come ti pare*/
