...
struct dict {
  nodo **a; // array di puntatori di nodi, diverso da a*[] (a*[] fa si che venga
            // allocato nello scpazio riservato alla struct,quindi come se ci
            // fosse a m n in contiguo ma non va bene)
